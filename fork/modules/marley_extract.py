...
def marley_doc_to_w04_row(input_uid: str, doc: Dict[str, Any]) -> Dict[str, str]:
    return {
        ...
        "app_info.iapplicode": normalize_cell_value(app_info_value(doc, input_uid, "iapplicode")),
        ...
        "brand": normalize_cell_value(doc.get("brand")),
        "country": normalize_cell_value(doc.get("country")),
        "geo_zone": normalize_cell_value(doc.get("geo_zone")),
        "model": normalize_cell_value(doc.get("model")),
        "type": normalize_cell_value(doc.get("type")),
